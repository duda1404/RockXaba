    ...
    if (
        ...
        if ($stmt = $pdo->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                dat_add_artista = :dat_add_artista, FK_SITUACAO_id_sit = :FK_SITUACAO_id_sit, cor_artista = :cor_artista WHERE fk_usuario_id_user = $id";
                    ...
                    $body = "<strong>Este email foi utilizado para a realização do recadastro como Artista no site RockXaba, </strong> 
                ...
                Nome do Instagram: " . $nome_insta;
                    ...
                    $assunto = 'Solicitando o recadastro do(a) Artista/Banda';
