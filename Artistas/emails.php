...
try {
    ...
    */
    ...
    $fileCount = count($row_fotos_nome);

    $row_fotos_nome[$fileCount] = $photo_new_name_logo;

    /* inserindo as fotos no email */

    for ($i = 0; $i < ($fileCount + 1); $i++) {

        $mail->addAttachment('uploads/'.$row_fotos_nome[$i], 'uploads/'.$row_fotos_nome[$i]);
